...
import { X, Package, Building, Calendar, AlertTriangle, CheckCircle, Clock, Paperclip, Edit, Wrench } from 'lucide-react';
...
const EquipmentDetailModal: React.FC<EquipmentDetailModalProps> = ({ equipmentId, onClose, onEdit }) => {
